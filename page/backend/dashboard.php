...
<div class="container-sm mt-0 shadow-sm p-2 mb-2 mt-4" >
    <div class="card">
        
        <img src="./assets/dedazenprofile.png" class="img_profile" width="79px;" alt=""> 
        <h5 class="text-white mt-2"><?php echo $config['name'] ?></h5>

        <!-- -ข้อมูล -->
        
        <img src="<?php echo $config['logo']; ?>" width="150px;" alt="">
        <p class="title-2">รายละเอียดผู้ใช่งาน</p>
        <span class="title">- เว็บไซต์ : <span class="title-2"><?php echo $config['name']; ?></span></span>
        <span class="title">- ผู้ใช้งาน / แอดมิน : <span class="title-2"><?php echo htmlspecialchars($user["username"]); ?> </span></span>
        ...
        <a href="#" class="button">
            ...
            <div class="button-text mt-4">
                <span>* หาก<span class="fb"> อายุการใช้งานหมดแล้ว </span>ต้องการเช่าเว็บต่อ โปรดต่ออายุภายในระยะเวลา 3 วัน</span>
        ...
        <center class="button-text mt-4">
            หากพบเจอปัญหา หรือต้องการเช่าเว็บต่อ
        </center>

        <center>
            <div class="button-text mt-3">
                <a href="https://discord.gg/8Ty6fYhhYt" class="contect_admin btn">ต่ออายุการใช้งาน</a>
                <a href="<?php echo $config['contact'] ?>" class="contect_admin btn">แจ้งปัญหาเว็บไซต์</a>
            </div>
        </center>
